...
public class StudentHistoryFilterController {
  @FXML
  ...
  public void onConfirm() {
    if (onConfirmCallback != null) {
      ...
      if (start != null && end != null && start.isAfter(end)) {
        ...
        filterData.put("status", statusDropdown.getValue());
  ...
  public void setUniqueStatus(String[] uniqueStatus) {
    statusDropdown.getItems().addAll(uniqueStatus);
  }
  ...
  public void setPreviousData(Map<String, String> filterData) {
    ...
    statusDropdown.setValue(filterData.get("status"));
  }
